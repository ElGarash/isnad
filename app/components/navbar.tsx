...
import { Link as LinkIcon, Search, Users, Info } from "lucide-react"
      ...
      <div className="flex h-16">
        <div className="flex flex-1 items-center justify-around">
          ...
          <nav className="flex items-center space-x-6 rtl:space-x-reverse text-sm">
            <Link href="/search" className="relative overflow-hidden group flex items-center gap-1">
              <Search className="w-4 h-4" />
              <span className="relative z-10 transition-colors hover:text-foreground/80 mb-0.5">البحث</span>
            ...
            <Link href="/scholars" className="relative overflow-hidden group flex items-center gap-1">
              <Users className="w-4 h-4" />
              <span className="relative z-10 transition-colors hover:text-foreground/80 mb-0.5">الرواة</span>
              <span className="absolute bottom-0 left-0 w-full h-1 bg-parchment transform origin-left scale-x-0 transition-transform group-hover:scale-x-100"></span>
            </Link>
            <Link href="/about" className="relative overflow-hidden group flex items-center gap-1">
              <Info className="w-4 h-4" />
              <span className="relative z-10 transition-colors hover:text-foreground/80 mb-0.5">عن المشروع</span>
              <span className="absolute bottom-0 left-0 w-full h-1 bg-parchment transform origin-left scale-x-0 transition-transform group-hover:scale-x-100"></span>
            </Link>
          </nav>
        </div>
